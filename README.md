...
- `exoscale-vault.pkr.hcl` (Vault 1.11.3)
...
- `exoscale-kube-controlplane.pkr.hcl` (Kubernetes 1.25.1 control plane):
...
- `exoscale-kube-node.pkr.hcl` (Kubernetes 1.25.1 node):
    - Kubelet service.
