...
- `exoscale-vault.pkr.hcl` (Vault 1.11.0)
...
- `exoscale-kube-controlplane.pkr.hcl` (Kubernetes 1.24.2 control plane):
...
- `exoscale-kube-node.pkr.hcl` (Kubernetes 1.24.2 node):
    - Kubelet service.
